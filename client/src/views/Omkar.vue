...
export default {
  data (vm) {
    return {
      ...
      headers_DownT: [
        ...
        { text: 'Inlet Pressure Low', value: 'InletPressLow' },
        { text: 'Oil Tank Level Low', value: 'OilTankLowLevel' },
        { text: 'Control Oil Pressure Low', value: 'ControlOilPressLow' },
        { text: 'Reverse Power Trip', value: 'ReversePower' }
      ],
      desserts: Alarm,
      KWH: 0,
  ...
  methods: {
    ...
    async GetTDDowntime () {
      try {
        ...
        this.datasource_DT.data[3].value = response.data[0].OverSpeed / 3600
        this.datasource_DT.data[4].value = response.data[0].EmergencyStop / 3600
        this.datasource_DT.data[5].value = response.data[0].InletPressLow / 3600
        this.datasource_DT.data[6].value = response.data[0].OilTankLowLevel / 3600
        this.datasource_DT.data[7].value = response.data[0].ControlOilPressLow / 3600
        this.datasource_DT.data[8].value = response.data[0].ReversePower / 3600
      } catch (error) {
        console.log(error)
      }
    }
  ...
  mounted () {
    ...
    this.socket.on('m_data', (data) => {
      ...
      this.r1 = data
      if (this.r1.length !== 0) {
        RY_C_D = this.r1[7].data
        YB_C_D = this.r1[8].data
        BR_C_D = this.r1[9].data
        R_V = this.r1[10].data
        Y_V = this.r1[11].data
        B_V = this.r1[12].data
        HZ_D = this.r1[5].data
        RPM_D = this.r1[21].data
        PF_D = this.r1[17].data
        BACK_P_D = this.r1[18].data
        INLET_P_D = this.r1[19].data
        OIL_P_D = this.r1[20].data
        KVAH_D = this.r1[16].data
        this.KWH = this.r1[6].data
        this.PV = this.r1[18].data
        this.OP = (this.r1[41].data) / 100
        this.SP = this.r1[40].data
        this.MA = (this.r1[42].data) / 100
        this.LATCH_RPM = this.r1[43].data
        this.TRIP_RPM = this.r1[44].data
        this.AOP_RPM = this.r1[45].data
      }
    })
